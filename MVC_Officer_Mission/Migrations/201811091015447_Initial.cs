    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.Officer_Id, t.Mission_Id })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.OfficerMissions", "Mission_Id", "dbo.Missions");
            DropForeignKey("dbo.OfficerMissions", "Officer_Id", "dbo.Officers");
            DropIndex("dbo.OfficerMissions", new[] { "Mission_Id" });
            DropIndex("dbo.OfficerMissions", new[] { "Officer_Id" });
